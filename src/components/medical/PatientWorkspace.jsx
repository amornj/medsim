...
const EQUIPMENT_ICONS = {
  ...
  fluoroscopy: Radio,
  echo_machine: Heart,
  vascular_ultrasound: Activity,
  blood_gas_analyzer: Droplets,
  glucometer: Activity,
  coagulation_analyzer: Droplets,
  lactate_meter: Activity,
  troponin_assay: Heart,
  c_collar: Activity,
  backboard: Activity,
  pelvic_binder: Activity,
  tourniquet: Activity,
  traction_splint: Activity,
  chest_seal: Wind,
  laryngoscope: Activity,
  video_laryngoscope: Radio,
  bougie: Syringe,
  lma: Wind,
  king_airway: Wind,
  ambu_bag: Wind,
  suction_unit: Droplets,
  iv_catheter: Syringe,
  central_line_kit: Syringe,
  io_drill: Activity,
  picc_line: Syringe,
  ultrasound_vascular: Radio
};
...
const EQUIPMENT_COLORS = {
  ...
  fast_exam: 'bg-cyan-100 text-cyan-700 border-cyan-300',
  capnography: 'bg-teal-100 text-teal-700 border-teal-300',
  bis_monitor: 'bg-purple-100 text-purple-700 border-purple-300',
  nirs: 'bg-pink-100 text-pink-700 border-pink-300',
  bladder_scanner: 'bg-cyan-100 text-cyan-700 border-cyan-300',
  portable_xray: 'bg-slate-100 text-slate-700 border-slate-300',
  ct_scanner: 'bg-blue-100 text-blue-700 border-blue-300',
  mri_scanner: 'bg-purple-100 text-purple-700 border-purple-300',
  fluoroscopy: 'bg-cyan-100 text-cyan-700 border-cyan-300',
  echo_machine: 'bg-red-100 text-red-700 border-red-300',
  vascular_ultrasound: 'bg-teal-100 text-teal-700 border-teal-300',
  blood_gas_analyzer: 'bg-red-100 text-red-700 border-red-300',
  glucometer: 'bg-yellow-100 text-yellow-700 border-yellow-300',
  coagulation_analyzer: 'bg-purple-100 text-purple-700 border-purple-300',
  lactate_meter: 'bg-orange-100 text-orange-700 border-orange-300',
  troponin_assay: 'bg-pink-100 text-pink-700 border-pink-300',
  c_collar: 'bg-amber-100 text-amber-700 border-amber-300',
  backboard: 'bg-slate-100 text-slate-700 border-slate-300',
  pelvic_binder: 'bg-orange-100 text-orange-700 border-orange-300',
  tourniquet: 'bg-red-100 text-red-700 border-red-300',
  traction_splint: 'bg-yellow-100 text-yellow-700 border-yellow-300',
  chest_seal: 'bg-blue-100 text-blue-700 border-blue-300',
  laryngoscope: 'bg-blue-100 text-blue-700 border-blue-300',
  video_laryngoscope: 'bg-cyan-100 text-cyan-700 border-cyan-300',
  bougie: 'bg-yellow-100 text-yellow-700 border-yellow-300',
  lma: 'bg-teal-100 text-teal-700 border-teal-300',
  king_airway: 'bg-green-100 text-green-700 border-green-300',
  ambu_bag: 'bg-lime-100 text-lime-700 border-lime-300',
  suction_unit: 'bg-indigo-100 text-indigo-700 border-indigo-300',
  iv_catheter: 'bg-blue-100 text-blue-700 border-blue-300',
  central_line_kit: 'bg-red-100 text-red-700 border-red-300',
  io_drill: 'bg-orange-100 text-orange-700 border-orange-300',
  picc_line: 'bg-purple-100 text-purple-700 border-purple-300',
  ultrasound_vascular: 'bg-cyan-100 text-cyan-700 border-cyan-300'
};
...
const EQUIPMENT_NAMES = {
  ...
  bis_monitor: 'BIS Monitor',
  nirs: 'NIRS (Cerebral Oximetry)',
  bladder_scanner: 'Bladder Scanner',
  portable_xray: 'Portable X-Ray',
  ct_scanner: 'CT Scanner',
  mri_scanner: 'MRI Scanner',
  fluoroscopy: 'Fluoroscopy Machine',
  echo_machine: 'Echocardiography Machine',
  vascular_ultrasound: 'Vascular Ultrasound',
  blood_gas_analyzer: 'Blood Gas Analyzer',
  glucometer: 'Glucometer',
  coagulation_analyzer: 'Coagulation Analyzer',
  lactate_meter: 'Lactate Meter',
  troponin_assay: 'Troponin Rapid Assay',
  ...
  video_laryngoscope: 'Video Laryngoscope (GlideScope)',
  bougie: 'Bougie (Gum Elastic)',
  lma: 'Laryngeal Mask Airway (LMA)',
  king_airway: 'King Airway',
  ambu_bag: 'Ambu Bag (BVM)',
  suction_unit: 'Suction Unit',
  iv_catheter: 'Peripheral IV Catheter',
  central_line_kit: 'Central Line Kit',
  io_drill: 'Intraosseous Drill (EZ-IO)',
  picc_line: 'PICC Line Kit',
  ultrasound_vascular: 'Ultrasound-Guided Access'
};
...
const EQUIPMENT_COSTS = {
  ...
  nirs: 7000, bladder_scanner: 4000, portable_xray: 12000, ct_scanner: 25000, mri_scanner: 35000,
  fluoroscopy: 20000, echo_machine: 15000, vascular_ultrasound: 10000, blood_gas_analyzer: 8000,
  glucometer: 200, coagulation_analyzer: 5000, lactate_meter: 3000, troponin_assay: 2000,
  c_collar: 100, backboard: 200, pelvic_binder: 300, tourniquet: 50, traction_splint: 500,
  chest_seal: 150, laryngoscope: 2000, video_laryngoscope: 8000, bougie: 300, lma: 500,
  king_airway: 400, ambu_bag: 300, suction_unit: 1500, iv_catheter: 50, central_line_kit: 800,
